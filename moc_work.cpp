...
void work::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (work::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&work::log)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject work::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_work.data,
